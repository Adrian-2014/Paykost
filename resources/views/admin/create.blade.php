        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="offcanvas-md offcanvas-end" tabindex="-1" id="sidebarMenu">
                        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="/admin/index">
                            ...
                            <ul class="nav flex-column mb-auto">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 active" href="/admin/create" style="color: rgb(0, 179, 255);">
                                        <i class="bi bi-file-earmark-plus" style="color: rgb(0, 179, 255); font-size: 1rem;"></i>
                                        Buat
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2" href="#" style="color: rgb(0, 179, 255);">
                                ...
                                <li class="nav-item">
                                    <form action="/logout" method="get">
                                        @csrf
                                        <button type="submit" class="nav-link d-flex align-items-center gap-2" style="color: red;">
                ...
                <div class="isi col-lg-10">
                    <div class="cucibaju">
                        <a href="/admin/addCuciItem">Item Cuci</a>
                    </div>
